        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="reveal-stagger space-y-12">
            <div className="border-t border-[#e5e0d8] pt-8">
              ...
              <p className="text-xl text-[#6b6560]">Hornitos was globally renowned, but U.S. bartenders overlooked it. They preferred familiar brands. Traditional advertising wasn&apos;t breaking through.</p>
            </div>

            <div className="border-t border-b border-[#e5e0d8] pt-8 pb-8">
              <p className="text-5xl md:text-6xl text-[#f57214] mb-4">02</p>
              <h3 className="text-2xl md:text-3xl text-[#1a1a1a] mb-3">The Solution</h3>
              <p className="text-xl text-[#6b6560]">Create a consumer (and bartender) event around mixology. Make the tequila and its flexible nature unforgettable through hands-on experience.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="reveal-stagger space-y-8">
            <div className="border-t border-[#e5e0d8] pt-8">
              ...
              <p className="text-xl text-[#6b6560]">Training NYC bartenders live as a means to force education and mixology usage.</p>
            </div>

            <div className="border-t border-b border-[#e5e0d8] pt-8 pb-8">
              <h3 className="text-2xl md:text-3xl text-[#1a1a1a] mb-3">Innovative solutions</h3>
              <p className="text-xl text-[#6b6560]">Branded mixology handbook developed to further engage bartenders and consumers post event.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="reveal-stagger grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-xl text-[#6b6560]">open rate</p>
            </div>
            <div>
              <div className="text-7xl md:text-8xl text-[#f57214] leading-none mb-2">79%</div>
              <p className="text-xl text-[#6b6560]">attendance</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="reveal-stagger space-y-8">
            <div className="border-t border-[#e5e0d8] pt-8">
              ...
              <p className="text-xl text-[#6b6560]">NYC&apos;s top bartenders became brand ambassadors, recommending Hornitos to customers and peers.</p>
            </div>

            <div className="border-t border-[#e5e0d8] pt-8">
              <h3 className="text-2xl md:text-3xl text-[#1a1a1a] mb-3">Cultural moment</h3>
              <p className="text-xl text-[#6b6560]">Partnership with Bon Jovi&apos;s 25th anniversary and Showtime created massive cultural relevance.</p>
            </div>

            <div className="border-t border-b border-[#e5e0d8] pt-8 pb-8">
              <h3 className="text-2xl md:text-3xl text-[#1a1a1a] mb-3">Lasting engagement</h3>
              <p className="text-xl text-[#6b6560]">The &ldquo;Mischievous Cocktails&rdquo; handbook extended the experience beyond the event.</p>
            </div>
          </div>
        </div>
      </section>
