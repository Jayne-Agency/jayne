        ...
        <div className="max-w-3xl mx-auto">
          <div className="reveal-stagger space-y-8">
            <p className="text-2xl md:text-3xl text-[#8a8178] leading-snug font-[family-name:var(--font-open-sans)]">
              Filecoin Foundation launched in 2020 with a cryptographic proof system no competitor could replicate and a story almost no one outside Web3 could understand.
            </p>
            <p className="text-2xl md:text-3xl text-[#8a8178] leading-snug font-[family-name:var(--font-open-sans)]">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="reveal-stagger space-y-12">
            <div className="border-t border-[#e5e0d8] pt-8">
              ...
              <p className="text-xl text-[#8a8178] font-[family-name:var(--font-open-sans)]">When Filecoin Foundation&apos;s mainnet launched in October 2020, they were the only storage provider that could claim daily cryptographic proof that every byte of stored data exists, is intact, and is retrievable. Except no one but the engineers who built it understood what that meant. The community was growing fast inside Web3. Outside of it, the story was hard to digest because most people don&apos;t speak &ldquo;Web3.&rdquo;</p>
            </div>

            <div className="border-t border-[#e5e0d8] pt-8">
              <p className="text-5xl md:text-6xl text-[#f57214] mb-4">02</p>
              <h3 className="text-2xl md:text-3xl text-[#1a1a1a] mb-3">The solution</h3>
              <p className="text-xl text-[#8a8178] font-[family-name:var(--font-open-sans)]">RWO built a strategy-first content engine designed to rapidly, clearly and simply translate Filecoin Foundation&apos;s proof mechanisms into stories that researchers, enterprise IT teams, policy makers, and storage clients could understand and rally behind. The content strategy spanned every channel where Filecoin Foundation&apos;s audiences lived&mdash;identifying the highest-leverage narratives: data verifiability, storage provenance, and the growing intersection of AI and decentralized infrastructure. From there, RWO coordinated content creation, marketing best-practices, set publishing cadences, and tracked KPIs continuously, building brand awareness and genuine community in parallel.</p>
            </div>
            ...
            <div className="border-t border-b border-[#e5e0d8] pt-8 pb-8">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-xl text-[#8a8178] font-[family-name:var(--font-open-sans)]">Filecoin Foundation found audiences it had never spoken to before and invited them into the ecosystem. People who never understood what distributed storage was, or why it was pertinent to the broader conversation around verifiable storage, began joining the conversation.</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-xl text-[#8a8178] font-[family-name:var(--font-open-sans)]">Filecoin Foundation built a consistent, recognizable presence.</p>
                </div>
                <div>
