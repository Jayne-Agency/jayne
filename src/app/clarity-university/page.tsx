    ...
    <main className="font-[family-name:var(--font-playfair)] bg-[#1a1a1a]">
      ...
      <section className="pt-32 pb-16 lg:pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl leading-[1.05] text-white opacity-0 animate-fade-in mb-8">
            Clarity University
          </h1>
          <p className="text-xl md:text-2xl text-[#b5b0a8] opacity-0 animate-fade-in animation-delay-100 font-[family-name:var(--font-open-sans)]">
      ...
      <section className="py-24 lg:py-32 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="reveal text-4xl md:text-5xl text-white leading-tight mb-16">
            Recognize Any of These?
          </h2>
          ...
          <div className="space-y-12">
            <div className="reveal">
              ...
              <p className="text-xl md:text-2xl text-[#b5b0a8] font-[family-name:var(--font-open-sans)]">Struggling to resonate with your audience?</p>
            </div>

            <div className="reveal">
              <p className="text-2xl md:text-3xl text-[#f57214] font-semibold font-[family-name:var(--font-open-sans)] mb-2">Lost for Words?</p>
              <p className="text-xl md:text-2xl text-[#b5b0a8] font-[family-name:var(--font-open-sans)]">Don&apos;t have a strong 11-second elevator pitch?</p>
            </div>

            <div className="reveal">
              <p className="text-2xl md:text-3xl text-[#f57214] font-semibold font-[family-name:var(--font-open-sans)] mb-2">Market Shifts?</p>
              <p className="text-xl md:text-2xl text-[#b5b0a8] font-[family-name:var(--font-open-sans)]">Finding it hard to adapt your messaging to changing customer needs?</p>
            </div>
            ...
            <div className="reveal">
              ...
              <p className="text-xl md:text-2xl text-[#b5b0a8] font-[family-name:var(--font-open-sans)]">Difficulty in crafting engaging, relevant content?</p>
            </div>
            ...
            <div className="reveal">
              ...
              <p className="text-xl md:text-2xl text-[#b5b0a8] font-[family-name:var(--font-open-sans)]">Don&apos;t Know Where to Start?</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 lg:py-32 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="reveal text-4xl md:text-5xl text-white leading-tight mb-8">
            It&apos;s Time to Strategize: Build your Brand Platform with Clarity University®
          </h2>
          <p className="reveal text-xl md:text-2xl text-[#b5b0a8] leading-relaxed font-[family-name:var(--font-open-sans)]">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            <div className="reveal">
              ...
              <p className="text-xl md:text-2xl text-[#b5b0a8] font-[family-name:var(--font-open-sans)]">Equip yourself with the knowledge to utilize ten key brand assets, driving financial growth, culture enhancement, and market share expansion.</p>
            </div>
            ...
            <div className="reveal">
              ...
              <p className="text-xl md:text-2xl text-[#b5b0a8] font-[family-name:var(--font-open-sans)]">Engage in a guided, hands-on approach to developing your Brand Platform, transforming your brand&apos;s theoretical concepts into actionable strategies.</p>
            </div>
            ...
            <div className="reveal">
              ...
              <p className="text-xl md:text-2xl text-[#b5b0a8] font-[family-name:var(--font-open-sans)]">Learn to concisely and effectively communicate your brand&apos;s position and promise, making every interaction count.</p>
            </div>
            ...
            <div className="reveal">
              ...
              <p className="text-xl md:text-2xl text-[#b5b0a8] font-[family-name:var(--font-open-sans)]">Gain access to live support through Q&A webinars and a vibrant community for ongoing feedback and networking.</p>
            </div>
            ...
            <div className="reveal">
              ...
              <p className="text-xl md:text-2xl text-[#b5b0a8] font-[family-name:var(--font-open-sans)]">Whether you&apos;re a business leader or designating a team member, the program&apos;s flexibility allows for effective learning and application within your organization.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 lg:py-32 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="reveal grid md:grid-cols-3 gap-8 mb-16">
            {/* Essentials */}
            <div className="bg-[#252525] rounded-2xl p-8 flex flex-col">
              <h3 className="text-2xl md:text-3xl text-white mb-4">Essentials</h3>
              <p className="text-4xl md:text-5xl text-[#f57214] font-semibold mb-6">$1,600</p>
              <ul className="space-y-4 text-[#b5b0a8] font-[family-name:var(--font-open-sans)] flex-1">
                <li className="flex items-start gap-3">
                  <span className="text-green-500 mt-1">✓</span>
                  <span><strong className="text-white">Week 1:</strong> Brand Platform Primer and Workbook Guidance Session</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-500 mt-1">✓</span>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-[#666]"><strong>Week 2:</strong> Workbook Homework + One-on-One Support</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-500 mt-1">✓</span>
                  <span><strong className="text-white">Week 3:</strong> Live Q&A Webinar</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#666] mt-1">✗</span>
                  <span className="text-[#666]"><strong>Week 4:</strong> Test Your Messaging Workshop</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#666] mt-1">✗</span>
                  <span className="text-[#666]">Inclusion in the Clarity University Business Directory</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#666] mt-1">✗</span>
                  <span className="text-[#666]">Certificate of Program Completion</span>
                </li>
              </ul>
              <Link
                href="/clarity-university/essentials"
                className="mt-8 group inline-flex items-center justify-center gap-3 px-8 py-4 text-lg bg-white text-[#1a1a1a] rounded-lg transition-all duration-300 w-full"
              >
                Essentials
            ...
            {/* Plus - Most Popular */}
            <div className="bg-[#252525] rounded-2xl p-8 flex flex-col border-2 border-[#f57214] relative">
              ...
              <h3 className="text-2xl md:text-3xl text-white mb-4">Plus</h3>
              ...
              <ul className="space-y-4 text-[#b5b0a8] font-[family-name:var(--font-open-sans)] flex-1">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-green-500 mt-1">✓</span>
                  <span><strong className="text-white">Week 2:</strong> 1-Hour Workbook Guidance</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-500 mt-1">✓</span>
                  <span><strong className="text-white">Week 3:</strong> Live Q&A Webinar</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-green-500 mt-1">✓</span>
                  <span><strong className="text-white">Week 4:</strong> Test Your Messaging Workshop</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-500 mt-1">✓</span>
            ...
            {/* ConsultPlus */}
            <div className="bg-[#252525] rounded-2xl p-8 flex flex-col">
              <h3 className="text-2xl md:text-3xl text-white mb-4">ConsultPlus</h3>
              ...
              <ul className="space-y-4 text-[#b5b0a8] font-[family-name:var(--font-open-sans)] flex-1">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-green-500 mt-1">✓</span>
                  <span><strong className="text-white">Week 2:</strong> 2.5 Hours Brand Strategy Consulting</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-500 mt-1">✓</span>
                  <span><strong className="text-white">Week 3:</strong> Live Q&A Webinar</span>
      ...
      <section className="py-24 lg:py-32 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="reveal grid md:grid-cols-2 gap-8 lg:gap-12">
            <div className="bg-[#252525] rounded-2xl p-8 lg:p-10">
              <span className="text-6xl lg:text-7xl text-[#f57214] leading-none font-serif">&ldquo;</span>
              <p className="text-lg lg:text-xl text-white leading-relaxed mt-4 mb-8">
      ...
      <section className="py-24 lg:py-32 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="reveal text-xl md:text-2xl text-[#b5b0a8] leading-relaxed mb-12 font-[family-name:var(--font-open-sans)]">
